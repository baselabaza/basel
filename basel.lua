...
- Hi Bro in basel Source .
- Source Channels => @BASELABAZA & @jjxxh .
- Written BY => @xb_0b .
]].."\27[m")

io.popen("mkdir basel_Files")
t = "\27[35m".."\nAll Files Started : \n____________________\n"..'\27[m'
i = 0
for v in io.popen('ls basel_Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
function DevBot(msg) 
local hash = database:sismember(bot_id.."basel:Sudo:User", msg.sender_user_id_) 
if hash or Devbasel(msg) then  
return true  
else  
return false  
end  
...
local hash = database:sismember(bot_id.."basel:Basic:Constructor23"..msg.chat_id_, msg.sender_user_id_) 
if hash or Devbasel(msg) or DevBot(msg) then    
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."basel:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or Devbasel(msg) or DevBot(msg) or Constructoryyu(msg) then 
return true 
else 
return false 
end 
...
local hash = database:sismember(bot_id.."basel:Constructor"..msg.chat_id_, msg.sender_user_id_) 
if hash or Devbasel(msg) or DevBot(msg) or Constructoryyu(msg) or  BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
function Owner(msg)
local hash = database:sismember(bot_id.."basel:Manager"..msg.chat_id_,msg.sender_user_id_)    
if hash or Devbasel(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."basel:Mod:User"..msg.chat_id_,msg.sender_user_id_)    
if hash or Devbasel(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
function Vips(msg)
local hash = database:sismember(bot_id.."basel:Special:User"..msg.chat_id_,msg.sender_user_id_) 
if hash or Devbasel(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
...
var = true  
elseif database:sismember(bot_id.."basel:Sudo:User", user_id) then
var = true  
elseif database:sismember(bot_id.."basel:Basic:Constructor"..chat_id, user_id) then
var = true
elseif database:sismember(bot_id.."basel:Constructor"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."basel:Manager"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."basel:Mod:User"..chat_id, user_id) then
var = true  
elseif database:sismember(bot_id.."basel:Special:User"..chat_id, user_id) then  
var = true  
else  
var = false  
end  
...
var = "مطور السورس"
elseif Devbasele(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
elseif database:sismember(bot_id.."basel:Sudo:User", user_id) then
var = database:get(bot_id.."basel:Sudo:Rd"..chat_id) or "المطور"  
elseif database:sismember(bot_id.."basel:Basic:Constructor23"..chat_id, user_id) then
var = "المالك"
elseif database:sismember(bot_id.."basel:Basic:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."basel:BasicConstructor:Rd"..chat_id) or "المنشئ اساسي"
elseif database:sismember(bot_id.."basel:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."basel:Constructor:Rd"..chat_id) or "المنشئ"  
elseif database:sismember(bot_id.."basel:Manager"..chat_id, user_id) then
var = database:get(bot_id.."basel:Manager:Rd"..chat_id) or "المدير"  
elseif database:sismember(bot_id.."basel:Mod:User"..chat_id, user_id) then
var = database:get(bot_id.."basel:Mod:Rd"..chat_id) or "الادمن"  
elseif database:sismember(bot_id.."basel:Special:User"..chat_id, user_id) then  
var = database:get(bot_id.."basel:Special:Rd"..chat_id) or "المميز"  
else  
var = database:get(bot_id.."basel:Memp:Rd"..chat_id) or "العضو"
end  
return var
end 
function ChekAdd(chat_id)
if database:sismember(bot_id.."basel:Chek:Groups",chat_id) then
var = true
else 
var = false
end
...
if database:sismember(bot_id.."basel:Muted:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."basel:Ban:User"..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if database:sismember(bot_id.."basel:GBan:User",User_id) then
Var = true
else
Var = false
end
...
for basel in string.gmatch(data.first_name_, "[^%s]+") do
data.first_name_ = basel
end
...
database:sadd(bot_id..'basel:Chek:Groups',idg) 
database:set(bot_id.."basel:Lock:tagservrbot"..idg,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'basel:'..lock..idg,"del")    
end
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
database:sadd(bot_id.."basel:Constructor"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
database:sadd(bot_id.."basel:Manager"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
database:sadd(bot_id.."basel:Mod:User"..idg,idmod)  
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
database:sadd(bot_id.."basel:Basic:Constructor"..idg,idASAS)  
end;end
if v.linkgroup then
if v.linkgroup ~= "" then
database:set(bot_id.."basel:Private:Group:Link"..idg,v.linkgroup)   
end;end;end
...
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_,msg.sender_user_id_) 
...
function basel_Files(msg)
for v in io.popen('ls basel_Files'):lines() do
if v:match(".lua$") then
plugin = dofile("basel_Files/"..v)
if plugin.basel and msg then
pre_msg = plugin.basel(msg)
end
end
end
send(msg.chat_id_, msg.id_,pre_msg)  
end
function basel_Started_Bot(msg,data) 
if msg then
...
database:incr(bot_id..'basel:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) 
Chat_Type = 'GroupBot' 
elseif id:match("^(%d+)") then
database:sadd(bot_id..'basel:UsersBot',msg.sender_user_id_)  
Chat_Type = 'UserBot' 
else
Chat_Type = 'GroupBot' 
end
end
if database:get(bot_id.."basel:basel:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "◈︙ الغاء ." then   
send(msg.chat_id_, msg.id_,"◈︙ تم الغاء الاذاعة .") 
database:del(bot_id.."basel:basel:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."basel:Chek:Groups") 
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
database:set(bot_id..'basel:Msg:Pin:Chat'..v,msg.content_.text_) 
end
...
database:set(bot_id..'basel:Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
database:set(bot_id..'basel:Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(list) do 
sendSticker(v, 0, msg.content_.sticker_.sticker_.persistent_id_)   
database:set(bot_id..'basel:Msg:Pin:Chat'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Vips(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."basel:flooding:settings:"..msg.chat_id_,"flood") then 
floods = database:hget(bot_id.."basel:flooding:settings:"..msg.chat_id_,"flood") or "nil"
Num_Msg_Max = database:hget(bot_id.."basel:flooding:settings:"..msg.chat_id_,"floodmax") or 5
Time_Spam = database:hget(bot_id.."basel:flooding:settings:"..msg.chat_id_,"floodtime") or 5
local post_count = tonumber(database:get(bot_id.."basel:floodc:"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."basel:flooding:settings:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."basel:flooding:settings:"..msg.chat_id_,"flood") 
Is_Not_Spam(msg,type)  
end
database:setex(bot_id.."basel:floodc:"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(database:hget(bot_id.."basel:flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if database:hget(bot_id.."basel:flooding:settings:"..msg.chat_id_,"floodmax") then
Num_Msg_Max = database:hget(bot_id.."basel:flooding:settings:"..msg.chat_id_,"floodmax") 
end
if database:hget(bot_id.."basel:flooding:settings:"..msg.chat_id_,"floodtime") then
Time_Spam = database:hget(bot_id.."basel:flooding:settings:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."basel:Lock:text"..msg.chat_id_) and not Vips(msg) then       
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
database:incr(bot_id.."basel:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Vips(msg) then   
if database:get(bot_id.."basel:Lock:AddMempar"..msg.chat_id_) == "kick" then
...
if database:get(bot_id.."basel:Lock:Join"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
Reply_Status(msg,msg.sender_user_id_,"reply","◈︙ الاستيكر ممنوع عمري .")  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false   
end
end
...
if database:get(bot_id.."basel:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:User:Name"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if database:get(bot_id.."basel:Lock:hashtak"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:hashtak"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:hashtak"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:hashtak"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if database:get(bot_id.."basel:Lock:Cmd"..msg.chat_id_) == "del" and not Vips(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Cmd"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Cmd"..msg.chat_id_) == "kick" and not Vips(msg) then    
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Cmd"..msg.chat_id_) == "ktm" and not Vips(msg) then    
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."basel:Lock:Link"..msg.chat_id_) == "del" and not Vips(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Link"..msg.chat_id_) == "ked" and not Vips(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Link"..msg.chat_id_) == "kick" and not Vips(msg) then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Link"..msg.chat_id_) == "ktm" and not Vips(msg) then
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."basel:Lock:Photo"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Photo"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Photo"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Photo"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."basel:Lock:Video"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Video"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Video"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Video"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."basel:Lock:Animation"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Animation"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Animation"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Animation"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."basel:Lock:geam"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:geam"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:geam"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:geam"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."basel:Lock:Audio"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Audio"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Audio"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Audio"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."basel:Lock:vico"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:vico"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:vico"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:vico"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."basel:Lock:Keyboard"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Keyboard"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Keyboard"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Keyboard"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."basel:Lock:Sticker"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Sticker"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Sticker"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Sticker"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."basel:Lock:forward"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."basel:Lock:forward"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."basel:Lock:forward"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif database:get(bot_id.."basel:Lock:forward"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if database:get(bot_id.."basel:Lock:Document"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Document"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Document"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Document"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if database:get(bot_id.."basel:Lock:Unsupported"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Unsupported"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Unsupported"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Unsupported"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not Vips(msg) then
if database:get(bot_id.."basel:Lock:Markdaun"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Markdaun"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Markdaun"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Markdaun"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if database:get(bot_id.."basel:Lock:Inlen"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Inlen"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Inlen"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Inlen"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end 
...
if database:get(bot_id.."basel:Lock:Contact"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Contact"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Contact"..msg.chat_id_) == "kick" then
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Contact"..msg.chat_id_) == "ktm" then
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if database:get(bot_id.."basel:Lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Kick_Group(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."basel:Lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
--------------------------------------------------------------------------------------------------------------
local status_welcome = database:get(bot_id.."basel:Chek:Welcome"..msg.chat_id_)
if status_welcome and not database:get(bot_id.."basel:Lock:tagservr"..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local GetWelcomeGroup = database:get(bot_id.."basel:Get:Welcome:Group"..msg.chat_id_)  
...
database:set(bot_id.."basel:Pin:Id:Msg"..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = database:get(bot_id.."basel:Pin:Id:Msg"..msg.chat_id_)
if Msg_Pin and database:get(bot_id.."basel:lockpin"..msg.chat_id_) then
...
if database:get(bot_id.."basel:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) then 
...
database:del(bot_id.."basel:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."basel:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"◈︙ تم الغاء وضع البايو .") 
database:del(bot_id.."basel:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."basel:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."basel:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_,"◈︙ تم الغاء حفظ الترحيب .") 
database:del(bot_id.."basel:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."basel:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id.."basel:Get:Welcome:Group"..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"◈︙ تم حفظ الترحيب عمري .")   
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."basel:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"◈︙ تم الغاء حفظ الرابط .")       
database:del(bot_id.."basel:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
if text and text:match("(https://telegram.me/joinchat/%S+)") or text and text:match("(https://t.me/joinchat/%S+)") then     
local Link = text:match("(https://telegram.me/joinchat/%S+)") or text:match("(https://t.me/joinchat/%S+)")   
database:set(bot_id.."basel:Private:Group:Link"..msg.chat_id_,Link)
...
if database:get(bot_id.."basel:basel:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "◈︙ الغاء ." then   
send(msg.chat_id_, msg.id_,"◈︙ تم الغاء الاذاعة .") 
database:del(bot_id.."basel:basel:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id..'basel:UsersBot')  
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
end
...
if database:get(bot_id.."basel:basel:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "◈︙ الغاء ." then   
send(msg.chat_id_, msg.id_,"◈︙ تم الغاء الاذاعة .") 
database:del(bot_id.."basel:basel:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = database:smembers(bot_id.."basel:Chek:Groups") 
if msg.content_.text_ then
...
if database:get(bot_id.."basel:basel:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "◈︙ الغاء ." then   
send(msg.chat_id_, msg.id_,"◈︙ تم الغاء الاذاعة .") 
database:del(bot_id.."basel:basel:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
...
if database:get(bot_id.."basel:basel:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "◈︙ الغاء ." then   
send(msg.chat_id_, msg.id_,"◈︙ تم الغاء الاذاعة .") 
database:del(bot_id.."basel:basel:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = database:smembers(bot_id.."basel:UsersBot")   
...
local basel_Msg = database:get(bot_id.."basel:Add:Filter:Rp2"..text..msg.chat_id_)   
if basel_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply","◈︙"..basel_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
if database:get(bot_id.."basel:Set:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "◈︙ الغاء ." then   
send(msg.chat_id_, msg.id_,"◈︙ تم الغاء حفظ اسم البوت .") 
database:del(bot_id.."basel:Set:Name:Bot"..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."basel:Set:Name:Bot"..msg.sender_user_id_) 
database:set(bot_id.."basel:Name:Bot",text) 
send(msg.chat_id_, msg.id_, "◈︙ تم حفظ اسم البوت .")  
return false
end 
if text and database:get(bot_id.."basel:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
database:set(bot_id.."basel:Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"◈︙ ارسل الامر الجديد عمري .")  
database:del(bot_id.."basel:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
database:set(bot_id.."basel:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and database:get(bot_id.."basel:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = database:get(bot_id.."basel:Set:Cmd:Group:New"..msg.chat_id_)
database:set(bot_id.."basel:Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
database:sadd(bot_id.."basel:List:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,"◈︙ تم حفظ الامر .")  
database:del(bot_id.."basel:Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
--------------------------------------------------------------------------------------------------------------
...
database:set(bot_id.."basel:Lock:text"..msg.chat_id_,true) 
...
database:set(bot_id.."basel:Lock:AddMempar"..msg.chat_id_,"kick")  
...
database:set(bot_id.."basel:Lock:Join"..msg.chat_id_,"kick")  
...
database:set(bot_id.."basel:Lock:Bot:kick"..msg.chat_id_,"del")  
...
database:set(bot_id.."basel:Lock:Bot:kick"..msg.chat_id_,"kick")  
...
database:set(bot_id.."basel:Lock:tagservr"..msg.chat_id_,true)  
...
database:set(bot_id.."basel:lockpin"..msg.chat_id_, true) 
database:sadd(bot_id.."basel:Lock:pin",msg.chat_id_) 
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  database:set(bot_id.."basel:Pin:Id:Msg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
...
database:set(bot_id.."basel:Lock:edit"..msg.chat_id_,true) 
...
database:set(bot_id.."basel:Lock:tagservrbot"..msg.chat_id_,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'basel:'..lock..msg.chat_id_,"del")    
end
...
database:del(bot_id.."basel:Lock:AddMempar"..msg.chat_id_)  
...
database:del(bot_id.."basel:Lock:text"..msg.chat_id_)  
...
database:del(bot_id.."basel:Lock:Join"..msg.chat_id_)  
...
database:del(bot_id.."basel:Lock:Bot:kick"..msg.chat_id_)  
...
database:del(bot_id.."basel:Lock:tagservr"..msg.chat_id_)  
...
database:del(bot_id.."basel:lockpin"..msg.chat_id_)  
database:srem(bot_id.."basel:Lock:pin",msg.chat_id_)
...
database:del(bot_id.."basel:Lock:edit"..msg.chat_id_) 
...
database:del(bot_id.."basel:Lock:tagservrbot"..msg.chat_id_)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:del(bot_id..'basel:'..lock..msg.chat_id_)    
end
...
database:set(bot_id.."basel:Lock:Markdaun"..msg.chat_id_,"ktm")  
...
if text == ("المطورين") and Devbasel(msg) then
local list = database:smembers(bot_id.."basel:Sudo:User")
t = "\n◈︙ قائمة مطورين البوت .\n- - - - -\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."basel:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."basel:Basic:Constructor"..msg.chat_id_)
...
local list = database:smembers(bot_id.."basel:Constructor"..msg.chat_id_)
t = "\n◈︙ قائمة المنشئين .\n- - - - -\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."basel:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."basel:Manager"..msg.chat_id_)
t = "\n◈︙ قائمة المدراء .\n- - - - -\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."basel:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."basel:Mod:User"..msg.chat_id_)
t = "\n◈︙ قائمة الادمنية .\n- - - - -\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."basel:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."basel:Special:User"..msg.chat_id_)
...
local list = database:smembers(bot_id.."basel:Muted:User"..msg.chat_id_)
t = "\n◈︙ قائمة المكتومين .\n- - - - -\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."basel:User:Name" .. v)
if username then
...
local list = database:smembers(bot_id.."basel:Ban:User"..msg.chat_id_)
t = "\n◈︙ قائمة المحظورين .\n- - - - -\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."basel:User:Name" .. v)
if username then
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and Devbasel(msg) then
function Function_basel(extra, result, success)
...
database:sadd(bot_id.."basel:GBan:User", result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ تم حظره عام .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_basel, nil)
return false
end
if text and text:match("^حظر عام @(.*)$")  and Devbasel(msg) then
...
database:sadd(bot_id.."basel:GBan:User", result.id_)
Reply_Status(msg,result.id_,"reply","◈︙ تم حظره عام .")  
else
send(msg.chat_id_, msg.id_,"◈︙ لا يوجد حساب بهذا المعرف .")
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_basel, nil)
return false
end
if text and text:match("^حظر عام (%d+)$") and Devbasel(msg) then
...
database:sadd(bot_id.."basel:GBan:User", userid)
Reply_Status(msg,userid,"reply","◈︙ تم حظره عام .")  
return false
end
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and Devbasel(msg) then
function Function_basel(extra, result, success)
database:srem(bot_id.."basel:GBan:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ تم الغاء الحظر العام عنه .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_basel, nil)
return false
end
if text and text:match("^الغاء العام @(.*)$") and Devbasel(msg) then
local username = text:match("^الغاء العام @(.*)$") 
function Function_basel(extra, result, success)
if result.id_ then
Reply_Status(msg,result.id_,"reply","◈︙ تم الغاء الحظر العام عنه .")  
database:srem(bot_id.."basel:GBan:User", result.id_)
else
send(msg.chat_id_, msg.id_,"◈︙ لا يوجد حساب بهذا المعرف .")
end
end
...
if text and text:match("^الغاء العام (%d+)$") and Devbasel(msg) then
local userid = text:match("^الغاء العام (%d+)$")
database:srem(bot_id.."basel:GBan:User", userid)
Reply_Status(msg,userid,"reply","◈︙ تم الغاء الحظر العام عنه .")  
return false
end

if text == ("رفع مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Devbasel(msg) then
function Function_basel(extra, result, success)
database:sadd(bot_id.."basel:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ تم رفعه مطور .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_basel, nil)
return false 
end
if text and text:match("^رفع مطور @(.*)$") and Devbasel(msg) then
...
database:sadd(bot_id.."basel:Sudo:User", result.id_)
...
if text and text:match("^رفع مطور (%d+)$") and Devbasel(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id.."basel:Sudo:User", userid)
Reply_Status(msg,userid,"reply","◈︙ تم رفعه مطور .")  
return false 
end
if text == ("تنزيل مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Devbasel(msg) then
function Function_basel(extra, result, success)
database:srem(bot_id.."basel:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ تم حذفه من المطورين .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_basel, nil)
return false 
end
if text and text:match("^تنزيل مطور @(.*)$") and Devbasel(msg) then
local username = text:match("^تنزيل مطور @(.*)$")
function Function_basel(extra, result, success)
if result.id_ then
database:srem(bot_id.."basel:Sudo:User", result.id_)
...
if text and text:match("^تنزيل مطور (%d+)$") and Devbasel(msg) then
local userid = text:match("^تنزيل مطور (%d+)$")
database:srem(bot_id.."basel:Sudo:User", userid)
...
if res then
if res == 'false' then
send(msg.chat_id_,msg.id_,'◈︙ اشترك بقناة السورس وارجع دز الامر عمري .\n◈︙ قناة السورس : @BASELABAZA .')   
return false 
end end
function Function_basel(extra, result, success)
database:srem(bot_id.."basel:Basic:Constructor23"..msg.chat_id_, result.sender_user_id_)
...
function Function_basel(extra, result, success)
if result.id_ then
database:srem(bot_id.."basel:Basic:Constructor23"..msg.chat_id_, result.id_)
...
if database:get(bot_id.."botss:basel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n◈︙ ارسل الكلمة الان .')
database:set(bot_id.."botss:basel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:basel:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:basel:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:basel:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"◈︙ تم حذف الرد .")
database:del(bot_id..'botss:basel:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:basel:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:basel:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:basel:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:basel:List:Rd:Sudo", text)
return false
end
end
if text == ("مسح الردود المتعددة") and Devbasel(msg) then
 
local list = database:smembers(bot_id.."botss:basel:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:basel:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:basel:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:basel:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:basel:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"◈︙ تم حذف الردود المتعددة .")
end
if text == ("الردود المتعددة") and Devbasel(msg) then
...
if text == "اضف رد متعدد" and Devbasel(msg) then
 
database:set(bot_id.."botss:basel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"◈︙ ارسل الرد الان .")
end
if text == "حذف رد متعدد" and Devbasel(msg) then
 
database:set(bot_id.."botss:basel:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"◈︙ ارسل الرد المراد حذفه . ")
end
if text then  
local test = database:get(bot_id.."botss:basel:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:basel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:basel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:basel:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:basel:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:basel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:basel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:basel:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:basel:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:basel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:basel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:basel:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:basel:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:basel:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:basel:Add:Rd:Sudo:Text2"..text)   
...
function Function_basel(extra, result, success)
database:sadd(bot_id.."basel:Basic:Constructor23"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."basel:Basic:Constructor23"..msg.chat_id_, result.id_)
...
function Function_basel(extra, result, success)
database:sadd(bot_id.."basel:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."basel:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."basel:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_basel(extra, result, success)
database:srem(bot_id.."basel:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
...
function Function_basel(extra, result, success)
if result.id_ then
database:srem(bot_id.."basel:Basic:Constructor"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."basel:Basic:Constructor"..msg.chat_id_, userid)
...
function Function_basel(extra, result, success)
database:sadd(bot_id.."basel:Constructor"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."basel:Constructor"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."basel:Constructor"..msg.chat_id_, userid)
...
function Function_basel(extra, result, success)
database:srem(bot_id.."basel:Constructor"..msg.chat_id_, result.sender_user_id_)
...
function Function_basel(extra, result, success)
if result.id_ then
database:srem(bot_id.."basel:Constructor"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."basel:Constructor"..msg.chat_id_, userid)
...
function Function_basel(extra, result, success)
database:sadd(bot_id.."basel:Manager"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."basel:Manager"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."basel:Manager"..msg.chat_id_, userid)
...
function Function_basel(extra, result, success)
database:srem(bot_id.."basel:Manager"..msg.chat_id_, result.sender_user_id_)
...
function Function_basel(extra, result, success)
if result.id_ then
database:srem(bot_id.."basel:Manager"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."basel:Manager"..msg.chat_id_, userid)
...
function Function_basel(extra, result, success)
database:sadd(bot_id.."basel:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."basel:Mod:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."basel:Mod:User"..msg.chat_id_, userid)
...
function Function_basel(extra, result, success)
database:srem(bot_id.."basel:Mod:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_basel(extra, result, success)
if result.id_ then
database:srem(bot_id.."basel:Mod:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."basel:Mod:User"..msg.chat_id_, userid)
...
function Function_basel(extra, result, success)
database:sadd(bot_id.."basel:Special:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."basel:Special:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."basel:Special:User"..msg.chat_id_, userid)
...
function Function_basel(extra, result, success)
database:srem(bot_id.."basel:Special:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_basel(extra, result, success)
if result.id_ then
database:srem(bot_id.."basel:Special:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."basel:Special:User"..msg.chat_id_, userid)
...
if database:sismember(bot_id.."basel:Coomds"..msg.chat_id_,RTPA) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local baselrt = database:get(bot_id.."basel:Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if baselrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n◈︙ العضو : ["..data.first_name_.."](t.me/"..(data.username_ or "nn1nnn")..")".."\n◈︙ تم رفعه : "..RTPA.." هنا .\n")   
database:set(bot_id.."basel:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."basel:Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif baselrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n◈︙ العضو : ["..data.first_name_.."](t.me/"..(data.username_ or "nn1nnn")..")".."\n◈︙ تم رفعه : "..RTPA.." هنا .\n")   
database:set(bot_id.."basel:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."basel:Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif baselrt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"\n◈︙ العضو : ["..data.first_name_.."](t.me/"..(data.username_ or "nn1nnn")..")".."\n◈︙ تم رفعه : "..RTPA.." هنا .\n")   
database:set(bot_id.."basel:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."basel:Manager"..msg.chat_id_,result.sender_user_id_)  
elseif baselrt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n◈︙ العضو : ["..data.first_name_.."](t.me/"..(data.username_ or "nn1nnn")..")".."\n◈︙ تم رفعه : "..RTPA.." هنا .\n")   
end
end,nil)   
end   
...
database:srem(bot_id.."basel:Special:User"..msg.chat_id_,result.sender_user_id_)  
database:del(bot_id.."basel:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif baselrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n◈︙ العضو : ["..data.first_name_.."](t.me/"..(data.username_ or "nn1nnn")..")".."\n◈︙ تم تنزيله من : "..RTPA.." هنا .\n")   
database:srem(bot_id.."basel:Mod:User"..msg.chat_id_,result.sender_user_id_) 
database:del(bot_id.."basel:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
...
if database:sismember(bot_id.."basel:Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local baselrt = database:get(bot_id.."basel:Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if baselrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n◈︙ العضو : ["..result.title_.."](t.me/"..(text1[3] or "nn1nnn")..")".."\n◈︙ تم رفعه : "..text1[2].." هنا .")   
database:sadd(bot_id.."basel:Special:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."basel:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif baselrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n◈︙ العضو : ["..result.title_.."](t.me/"..(text1[3] or "nn1nnn")..")".."\n◈︙ تم رفعه : "..text1[2].." هنا .")   
database:sadd(bot_id.."basel:Mod:User"..msg.chat_id_,result.id_)  
database:set(bot_id.."basel:Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
...
database:srem(bot_id.."basel:Special:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."basel:Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif baselrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n◈︙ العضو : ["..result.title_.."](t.me/"..(text1[3] or "nn1nnn")..")".."\n◈︙ تم تنزيله من :"..text1[2].." هنا .")   
database:srem(bot_id.."basel:Mod:User"..msg.chat_id_,result.id_)  
database:del(bot_id.."basel:Comd:New:rt:User:"..msg.chat_id_..result.id_)
...
database:sadd(bot_id.."basel:Ban:User"..msg.chat_id_, result.sender_user_id_)
Kick_Group(result.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."basel:Ban:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."basel:Ban:User"..msg.chat_id_, userid)
...
database:srem(bot_id.."basel:Ban:User"..msg.chat_id_, result.sender_user_id_)
...
database:srem(bot_id.."basel:Ban:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."basel:Ban:User"..msg.chat_id_, userid)
...
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_, result.id_)
...
database:sadd(bot_id.."basel:Muted:User"..msg.chat_id_, userid)
...
function Function_basel(extra, result, success)
database:srem(bot_id.."basel:Muted:User"..msg.chat_id_, result.sender_user_id_)
...
function Function_basel(extra, result, success)
if result.id_ then
database:srem(bot_id.."basel:Muted:User"..msg.chat_id_, result.id_)
...
database:srem(bot_id.."basel:Muted:User"..msg.chat_id_, userid)
...
tdcli_function ({ID = "SearchPublicChat",username_ = TextEnd[4]}, Function_basel, nil)
return false
end
------------------------------------------------------------------------
...
if database:sismember(bot_id.."basel:Lock:pin",msg.chat_id_) and not Constructor(msg) then
...
database:set(bot_id.."basel:Pin:Id:Msg"..msg.chat_id_,msg.reply_to_message_id_)
...
database:del(bot_id.."basel:Pin:Id:Msg"..msg.chat_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"◈︙ اني مو ادمن يحلو .")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"◈︙ معندي صلاحية التثبيت .")  
...
database:hset(bot_id.."basel:flooding:settings:"..msg.chat_id_ ,"floodmax" ,Num) 
...
database:hset(bot_id.."basel:flooding:settings:"..msg.chat_id_ ,"floodtime" ,Num) 
send(msg.chat_id_, msg.id_,"◈︙ تم تعيين وقت التكرار : ("..Num..") .") 
end
if text == "ضع رابط" or text == "وضع رابط" then
if msg.reply_to_message_id_ == 0  and Addictive(msg) then  
send(msg.chat_id_,msg.id_,"◈︙ ارسل الرابط الان .")
database:setex(bot_id.."basel:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_,120,true) 
return false
end
end
if text == "تفعيل جلب الرابط" or text == 'تفعيل الرابط' then
if Addictive(msg) then  
database:set(bot_id.."basel:Link_Group"..msg.chat_id_,true) 
...
if Addictive(msg) then  
database:del(bot_id.."basel:Link_Group"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"◈︙ تم تعطيل جلب الرابط .") 
return false end
end
if text == "الرابط" then 
local status_Link = database:get(bot_id.."basel:Link_Group"..msg.chat_id_)
if not status_Link then
send(msg.chat_id_, msg.id_,"◈︙ جلب الرابط معطل .") 
return false  
end
local link = database:get(bot_id.."basel:Private:Group:Link"..msg.chat_id_)            
if link then                              
...
database:del(bot_id.."basel:Private:Group:Link"..msg.chat_id_) 
return false      
end
return false  
end
...
database:set(bot_id.."basel:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_,true) 
...
if Addictive(msg) then
database:setex(bot_id.."basel:Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if Addictive(msg) then
database:setex(bot_id.."basel:Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
t  = "◈︙ ارسل الترحيب الان ."
...
if database:get(bot_id.."basel:Get:Welcome:Group"..msg.chat_id_)   then 
Welcome = database:get(bot_id.."basel:Get:Welcome:Group"..msg.chat_id_)  
else 
...
database:set(bot_id.."basel:Chek:Welcome"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_,"◈︙ تم تفعيل الترحيب .") 
return false  
end
if text == "تعطيل الترحيب" and Addictive(msg) then  
database:del(bot_id.."basel:Chek:Welcome"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"◈︙ تم تعطيل الترحيب .") 
return false  
end
if text == "مسح الترحيب" or text == "حذف الترحيب" then 
if Addictive(msg) then
database:del(bot_id.."basel:Get:Welcome:Group"..msg.chat_id_) 
...
send(msg.chat_id_, msg.id_,'◈︙ تم مسح قائمة الاستيكرات الممنوعة .')  
end
...
local list = database:smembers(bot_id.."basel:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."basel:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."basel:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."basel:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n◈︙ قائمة المنع .\n- - - - -\n"
for k,v in pairs(list) do  
local basel_Msg = database:get(bot_id.."basel:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..basel_Msg.."}\n"    
end  
if #list == 0 then  
...
database:set(bot_id.."basel:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."basel:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"◈︙ ارسل التحذير الان .")  
database:set(bot_id.."basel:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."basel:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."basel:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."basel:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"◈︙ تم منع الكلمة وحفظ التحذير .")  
database:del(bot_id.."basel:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."basel:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."basel:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."basel:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
...
database:set(bot_id.."basel:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."basel:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."basel:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."basel:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."basel:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
if database:get(bot_id.."basel:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, "◈︙ تم الغاء حفظ القوانين .") 
database:del(bot_id.."basel:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."basel:Set:Rules:Group" .. msg.chat_id_,text) 
...
if Addictive(msg) then
database:setex(bot_id.."basel:Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:del(bot_id.."basel:Set:Rules:Group"..msg.chat_id_) 
end
end
if text == "القوانين" then 
local Set_Rules = database:get(bot_id.."basel:Set:Rules:Group" .. msg.chat_id_)   
if Set_Rules then     
...
local list = database:smembers(bot_id.."basel:List:Cmd:Group:New"..msg.chat_id_.."")
t = "◈︙ قائمة الاوامر المضافة .\n- - - - -\n"
for k,v in pairs(list) do
Cmds = database:get(bot_id.."basel:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..""..k.."- ("..v..") ~ {"..Cmds.."}\n"
else
t = t..""..k.."- ("..v..") \n"
...
local list = database:smembers(bot_id.."basel:List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."basel:Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
database:del(bot_id.."basel:List:Cmd:Group:New"..msg.chat_id_)
end
send(msg.chat_id_, msg.id_,"◈︙ تم حذف قائمة الاوامر المضافة .")  
end
end
if text == "اضف امر" and Constructor(msg) then
database:set(bot_id.."basel:Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
send(msg.chat_id_, msg.id_,"◈︙ ارسل الامر القديم .")  
return false
end
if text == "حذف امر" or text == "مسح امر" then 
if Constructor(msg) then
database:set(bot_id.."basel:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local list = database:smembers(bot_id.."basel:Coomds"..msg.chat_id_)
if #list == 0 then
...
for k,v in pairs(list) do
var = database:get(bot_id.."basel:Comd:New:rt:bot:"..v..msg.chat_id_)
if var then
t = t..""..k.."- "..v.." ~ ("..var..")\n"
else
t = t..""..k.."- "..v.."\n"
...
local list = database:smembers(bot_id.."basel:Coomds"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."basel:Comd:New:rt:bot:"..v..msg.chat_id_)
database:del(bot_id.."basel:Coomds"..msg.chat_id_)
end
...
database:set(bot_id.."basel:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
database:sadd(bot_id.."basel:Coomds"..msg.chat_id_,ComdNew)  
database:setex(bot_id.."basel:Comd:New"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
...
database:del(bot_id.."basel:Comd:New:rt:bot:"..ComdNew..msg.chat_id_)
send(msg.chat_id_, msg.id_, "◈︙ تم حذف الصلاحية .") 
end
if database:get(bot_id.."basel:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,"◈︙ تم الغاء الامر .") 
database:del(bot_id.."basel:Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = database:get(bot_id.."basel:Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
database:set(bot_id.."basel:Comd:New:rt:bot:"..textn..msg.chat_id_,text)
...
database:set(bot_id.."basel:Sudo:Rd"..msg.chat_id_,Teext)
...
database:set(bot_id.."basel:BasicConstructor:Rd"..msg.chat_id_,Teext)
...
database:set(bot_id.."basel:Constructor:Rd"..msg.chat_id_,Teext)
...
database:set(bot_id.."basel:Manager:Rd"..msg.chat_id_,Teext) 
...
database:set(bot_id.."basel:Mod:Rd"..msg.chat_id_,Teext)
...
database:set(bot_id.."basel:Special:Rd"..msg.chat_id_,Teext)
...
database:set(bot_id.."basel:Memp:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"◈︙ تم تغيير رد العضو الى : "..Teext)
end


if text == ("مسح ردود المدير") and Owner(msg) then
local list = database:smembers(bot_id.."basel:List:Manager"..msg.chat_id_.."")
for k,v in pairs(list) do
database:del(bot_id.."basel:Add:Rd:Manager:Gif"..v..msg.chat_id_)   
database:del(bot_id.."basel:Add:Rd:Manager:Vico"..v..msg.chat_id_)   
database:del(bot_id.."basel:Add:Rd:Manager:Stekrs"..v..msg.chat_id_)     
database:del(bot_id.."basel:Add:Rd:Manager:Text"..v..msg.chat_id_)   
database:del(bot_id.."basel:Add:Rd:Manager:Photo"..v..msg.chat_id_)
database:del(bot_id.."basel:Add:Rd:Manager:Video"..v..msg.chat_id_)
database:del(bot_id.."basel:Add:Rd:Manager:File"..v..msg.chat_id_)
database:del(bot_id.."basel:Add:Rd:Manager:Audio"..v..msg.chat_id_)
database:del(bot_id.."basel:List:Manager"..msg.chat_id_)
end
...
for k,v in pairs(list) do
if database:get(bot_id.."basel:Add:Rd:Manager:Gif"..v..msg.chat_id_) then
db = "متحركة ."
elseif database:get(bot_id.."basel:Add:Rd:Manager:Vico"..v..msg.chat_id_) then
db = "بصمة ."
elseif database:get(bot_id.."basel:Add:Rd:Manager:Stekrs"..v..msg.chat_id_) then
db = "ستكر ."
elseif database:get(bot_id.."basel:Add:Rd:Manager:Text"..v..msg.chat_id_) then
db = "رسالة ."
elseif database:get(bot_id.."basel:Add:Rd:Manager:Photo"..v..msg.chat_id_) then
db = "صورة ."
elseif database:get(bot_id.."basel:Add:Rd:Manager:Video"..v..msg.chat_id_) then
db = "فيد ."
elseif database:get(bot_id.."basel:Add:Rd:Manager:File"..v..msg.chat_id_) then
db = "ملف ."
elseif database:get(bot_id.."basel:Add:Rd:Manager:Audio"..v..msg.chat_id_) then
db = "اغنية ."
end
text = text..""..k.." : ("..v..") : {"..db.."}\n"
end
...
local test = database:get(bot_id.."basel:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_.."")
if database:get(bot_id.."basel:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."basel:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."basel:Add:Rd:Manager:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."basel:Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."basel:Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."basel:Add:Rd:Manager:Text"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."basel:Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."basel:Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."basel:Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
database:set(bot_id.."basel:Add:Rd:Manager:Photo"..test..msg.chat_id_, photo_in_group)  
end
...
database:set(bot_id.."basel:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد" and Owner(msg) then
send(msg.chat_id_, msg.id_,"◈︙ ارسل الكلمة الان .")
database:set(bot_id.."basel:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true2")
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."basel:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
...
database:set(bot_id.."basel:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1")
database:set(bot_id.."basel:Text:Manager"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:del(bot_id.."basel:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."basel:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."basel:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."basel:Add:Rd:Manager:Text"..text..msg.chat_id_)   
database:del(bot_id.."basel:Add:Rd:Manager:Photo"..text..msg.chat_id_)
database:del(bot_id.."basel:Add:Rd:Manager:Video"..text..msg.chat_id_)
database:del(bot_id.."basel:Add:Rd:Manager:File"..text..msg.chat_id_)
database:del(bot_id.."basel:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:sadd(bot_id.."basel:List:Manager"..msg.chat_id_.."", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."basel:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
send(msg.chat_id_, msg.id_,"◈︙ تم حذف الرد .")
database:del(bot_id.."basel:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."basel:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."basel:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
...
database:del(bot_id.."basel:Add:Rd:Manager:Audio"..text..msg.chat_id_)
database:del(bot_id.."basel:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."basel:List:Manager"..msg.chat_id_.."", text)
return false
end
end
if text and not database:get(bot_id.."basel:Reply:Manager"..msg.chat_id_) then
if not database:sismember(bot_id..'basel:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."basel:Add:Rd:Manager:Gif"..text..msg.chat_id_)   
local veico = database:get(bot_id.."basel:Add:Rd:Manager:Vico"..text..msg.chat_id_)   
local stekr = database:get(bot_id.."basel:Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
local Text = database:get(bot_id.."basel:Add:Rd:Manager:Text"..text..msg.chat_id_)   
local photo = database:get(bot_id.."basel:Add:Rd:Manager:Photo"..text..msg.chat_id_)
local video = database:get(bot_id.."basel:Add:Rd:Manager:Video"..text..msg.chat_id_)
local document = database:get(bot_id.."basel:Add:Rd:Manager:File"..text..msg.chat_id_)
local audio = database:get(bot_id.."basel:Add:Rd:Manager:Audio"..text..msg.chat_id_)
if Text then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
local NumMsg = database:get(bot_id..'basel:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local message_edit = database:get(bot_id..'basel:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
send(msg.chat_id_, msg.id_, Text)
database:sadd(bot_id.."basel:Spam:Group"..msg.sender_user_id_,text) 
end,nil)
end
if stekr then 
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and Devbasel(msg) then 
local list = database:smembers(bot_id.."basel:List:Rd:Sudo")
for k,v in pairs(list) do
database:del(bot_id.."basel:Add:Rd:Sudo:Gif"..v)   
database:del(bot_id.."basel:Add:Rd:Sudo:vico"..v)   
database:del(bot_id.."basel:Add:Rd:Sudo:stekr"..v)     
database:del(bot_id.."basel:Add:Rd:Sudo:Text"..v)   
database:del(bot_id.."basel:Add:Rd:Sudo:Photo"..v)
database:del(bot_id.."basel:Add:Rd:Sudo:Video"..v)
database:del(bot_id.."basel:Add:Rd:Sudo:File"..v)
database:del(bot_id.."basel:Add:Rd:Sudo:Audio"..v)
database:del(bot_id.."basel:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"◈︙ تم مسح ردود المطور .")
end
if text == ("ردود المطور") and Devbasel(msg) then 
local list = database:smembers(bot_id.."basel:List:Rd:Sudo")
text = "\n◈︙ قائمة ردود المطور .\n- - - - -\n"
for k,v in pairs(list) do
if database:get(bot_id.."basel:Add:Rd:Sudo:Gif"..v) then
db = " : متحركة ."
elseif database:get(bot_id.."basel:Add:Rd:Sudo:vico"..v) then
db = " : بصمة ."
elseif database:get(bot_id.."basel:Add:Rd:Sudo:stekr"..v) then
db = " : ستكر ."
elseif database:get(bot_id.."basel:Add:Rd:Sudo:Text"..v) then
db = " : رسالة ."
elseif database:get(bot_id.."basel:Add:Rd:Sudo:Photo"..v) then
db = " : صورة ."
elseif database:get(bot_id.."basel:Add:Rd:Sudo:Video"..v) then
db = " : فيد ."
elseif database:get(bot_id.."basel:Add:Rd:Sudo:File"..v) then
db = " : ملف ."
elseif database:get(bot_id.."basel:Add:Rd:Sudo:Audio"..v) then
db = " : اغنية ."
end
text = text..""..k.." : "..v.." "..db.."\n"
end
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = database:get(bot_id.."basel:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."basel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."basel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_)
if msg.content_.sticker_ then   
database:set(bot_id.."basel:Add:Rd:Sudo:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
database:set(bot_id.."basel:Add:Rd:Sudo:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
database:set(bot_id.."basel:Add:Rd:Sudo:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."basel:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content_.audio_ then
database:set(bot_id.."basel:Add:Rd:Sudo:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
database:set(bot_id.."basel:Add:Rd:Sudo:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
database:set(bot_id.."basel:Add:Rd:Sudo:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
database:set(bot_id.."basel:Add:Rd:Sudo:Photo"..test, photo_in_group)  
end
send(msg.chat_id_, msg.id_,"◈︙ تم حفظ الرد بنجاح .")
return false  
end  
...
if text == "اضف رد للكل" and Devbasel(msg) then 
send(msg.chat_id_, msg.id_,"◈︙ ارسل الكلمة الان .")
database:set(bot_id.."basel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and Devbasel(msg) then 
send(msg.chat_id_, msg.id_,"◈︙ ارسل الكلمة المراد حذفها .")
database:set(bot_id.."basel:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."basel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '◈︙ ارسل الرد الان . \n◈︙ يمكنك اضافة ( رسالة - ستكر - متحركة - فيديو - صورة - ملف ) .\n◈︙ يمكنك اضافة ما يلي .\n- `#username` : معرف المستخدم .\n- `#msgs` : عدد رسائل المستخدم .\n- `#name` : اسم المستخدم .\n- `#id` : ايدي المستخدم .\n- `#stast` : موقع المستخدم .\n- `#edit` : عدد السحكات .')
database:set(bot_id.."basel:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."basel:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."basel:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."basel:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"◈︙ تم حذف الرد من قائمة ردود المطور .")
list = {"Add:Rd:Sudo:Audio","Add:Rd:Sudo:File","Add:Rd:Sudo:Video","Add:Rd:Sudo:Photo","Add:Rd:Sudo:Text","Add:Rd:Sudo:stekr","Add:Rd:Sudo:vico","Add:Rd:Sudo:Gif"}
for k,v in pairs(list) do
database:del(bot_id..'basel:'..v..text)
end
database:del(bot_id.."basel:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."basel:List:Rd:Sudo", text)
return false
end
end

if text and not database:get(bot_id.."basel:Reply:Sudo"..msg.chat_id_) then
if not database:sismember(bot_id..'basel:Spam:Group'..msg.sender_user_id_,text) then
local anemi = database:get(bot_id.."basel:Add:Rd:Sudo:Gif"..text)   
local veico = database:get(bot_id.."basel:Add:Rd:Sudo:vico"..text)   
local stekr = database:get(bot_id.."basel:Add:Rd:Sudo:stekr"..text)     
local Text = database:get(bot_id.."basel:Add:Rd:Sudo:Text"..text)   
local photo = database:get(bot_id.."basel:Add:Rd:Sudo:Photo"..text)
local video = database:get(bot_id.."basel:Add:Rd:Sudo:Video"..text)
local document = database:get(bot_id.."basel:Add:Rd:Sudo:File"..text)
local audio = database:get(bot_id.."basel:Add:Rd:Sudo:Audio"..text)
...
if database:sismember(bot_id.."basel:Sudo:User",result.id_) then
dev = "مطور " else dev = "" end
if database:sismember(bot_id.."basel:Basic:Constructor"..msg.chat_id_, result.id_) then
crr = "منشئ اساسي " else crr = "" end
if database:sismember(bot_id.."basel:Constructor"..msg.chat_id_, result.id_) then
cr = "منشئ " else cr = "" end
if database:sismember(bot_id.."basel:Manager"..msg.chat_id_, result.id_) then
own = "مدير " else own = "" end
if database:sismember(bot_id.."basel:Mod:User"..msg.chat_id_, result.id_) then
mod = "مدير " else mod = "" end
if database:sismember(bot_id.."basel:Special:User"..msg.chat_id_, result.id_) then
...
database:srem(bot_id.."basel:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."basel:Special:User"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."basel:Sudo:User",msg.sender_user_id_) then
database:srem(bot_id.."basel:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."basel:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."basel:Manager"..msg.chat_id_, result.id_)
database:srem(bot_id.."basel:Constructor"..msg.chat_id_, result.id_)
database:srem(bot_id.."basel:Basic:Constructor"..msg.chat_id_,result.id_)
elseif database:sismember(bot_id.."basel:Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."basel:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."basel:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."basel:Manager"..msg.chat_id_, result.id_)
database:srem(bot_id.."basel:Constructor"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."basel:Constructor"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."basel:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."basel:Special:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."basel:Manager"..msg.chat_id_, result.id_)
elseif database:sismember(bot_id.."basel:Manager"..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id.."basel:Mod:User"..msg.chat_id_, result.id_)
database:srem(bot_id.."basel:Special:User"..msg.chat_id_, result.id_)
end
else
...
if database:sismember(bot_id.."basel:Sudo:User",result.sender_user_id_) then
dev = "مطور " else dev = "" end
if database:sismember(bot_id.."basel:Basic:Constructor"..msg.chat_id_, result.sender_user_id_) then
crr = "منشئ اساسي " else crr = "" end
if database:sismember(bot_id.."basel:Constructor"..msg.chat_id_, result.sender_user_id_) then
cr = "منشئ " else cr = "" end
if database:sismember(bot_id.."basel:Manager"..msg.chat_id_, result.sender_user_id_) then
own = "مدير " else own = "" end
if database:sismember(bot_id.."basel:Mod:User"..msg.chat_id_, result.sender_user_id_) then
mod = "ادمن " else mod = "" end
if database:sismember(bot_id.."basel:Special:User"..msg.chat_id_, result.sender_user_id_) then
vip = "مميز " else vip = ""
end
...
for k, v in pairs(list) do
x = x + 1
if database:get(bot_id.."basel:User:Name"..v.user_id_) then
t = t..""..x.." - {[@"..database:get(bot_id.."basel:User:Name"..v.user_id_).."]}\n"
else
t = t..""..x.." - {"..v.user_id_.."}\n"
end
end
...
if text == "رتبتي" then
local rtp = database:get(bot_id.."basel:Comd:New:rt:User:"..msg.chat_id_..msg.sender_user_id_) or Get_Rank(msg.sender_user_id_,msg.chat_id_)
...
if not database:get(bot_id.."basel:Kick:Me"..msg.chat_id_) then
...
database:del(bot_id.."basel:Kick:Me"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,Text) 
end
if text == "تعطيل اطردني" and Owner(msg) then  
database:set(bot_id.."basel:Kick:Me"..msg.chat_id_,true)  
Text = "\n◈︙ تم تعطيل امر اطردني ."
send(msg.chat_id_, msg.id_,Text) 
end
...
function Function_basel(extra, result, success)
if result.id_ then
if database:sismember(bot_id.."basel:Muted:User"..msg.chat_id_,result.id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."basel:Ban:User"..msg.chat_id_,result.id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."basel:GBan:User",result.id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
function Function_basel(extra, result, success)
if database:sismember(bot_id.."basel:Muted:User"..msg.chat_id_,result.sender_user_id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if database:sismember(bot_id.."basel:Ban:User"..msg.chat_id_,result.sender_user_id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if database:sismember(bot_id.."basel:GBan:User",result.sender_user_id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
database:sadd(bot_id.."basel:Mod:User"..msg.chat_id_, admins[i].user_id_)
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
database:srem(bot_id.."basel:Mod:User"..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
database:srem(bot_id.."basel:Mod:User"..msg.chat_id_, admins[i].user_id_)
...
database:sadd(bot_id.."basel:Basic:Constructor"..msg.chat_id_,b.id_)
end,nil)   
end,nil)   
end

if text == "غادر" then 
if DevBot(msg) and not database:get(bot_id.."basel:Left:Bot"..msg.chat_id_) then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,"◈︙ تم مغادرة الكروب .") 
database:srem(bot_id.."basel:Chek:Groups",msg.chat_id_)  
end
return false  
end
...
database:srem(bot_id.."basel:Chek:Groups",GP_ID[2])  
return false 
end
end
if text == "تفعيل المغادرة" and Devbasel(msg) then   
database:del(bot_id.."basel:Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"◈︙ تم تفعيل المغادرة .") 
return false 
end
if text == "تعطيل المغادرة" and Devbasel(msg) then  
database:set(bot_id.."basel:Left:Bot"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "◈︙ تم تعطيل المغادرة .") 
return false 
end
if text == (database:get(bot_id.."basel:Name:Bot") or "باسل") then
Namebot = (database:get(bot_id.."basel:Name:Bot") or "باسل")
local namebot = {
"يا حبيب "..Namebot.. " كول",
"ها عمري اني "..Namebot,
'ها يروحا كول ؟',
...
if Devbasel(msg) then
database:setex(bot_id.."basel:Set:Name:Bot"..msg.sender_user_id_,300,true) 
...
if database:get(bot_id.."basel:Status:Bc") and not Devbasel(msg) then 
send(msg.chat_id_, msg.id_,"◈︙ الاذاعة معطلة من المطور الاساسي .")
return false
end
database:setex(bot_id.."basel:basel:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."basel:basel:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"◈︙ ارسل الي تريد تذيعه .\n◈︙ يمكنك الغاء الاذاعة بأرسال كلمة الغاء .") 
return false
end  
...
database:setex(bot_id.."basel:basel:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"◈︙ ارسل الي تريد تذيعه .\n◈︙ يمكنك الغاء الاذاعة بأرسال كلمة الغاء .") 
return false
end  
...
database:setex(bot_id.."basel:basel:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:setex(bot_id.."basel:basel:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"◈︙ دز التوجيه عمري .") 
return false
end 

if text == "تفعيل الاذاعة" and Devbasel(msg) then  
database:del(bot_id.."basel:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n◈︙ تم تفعيل الاذاعة ." ) 
return false
end 
if text == "تعطيل الاذاعة" and Devbasel(msg) then  
database:set(bot_id.."basel:Status:Bc",true) 
send(msg.chat_id_, msg.id_,"\n◈︙ تم تعطيل الاذاعة .") 
return false
end 

if text == "الاعدادات" and Addictive(msg) then    
if database:get(bot_id.."basel:lockpin"..msg.chat_id_) then    
lock_pin = "✓"
else 
lock_pin = "✘"    
end
if database:get(bot_id.."basel:Lock:tagservr"..msg.chat_id_) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✘"    
end
if database:get(bot_id.."basel:Lock:text"..msg.chat_id_) then    
lock_text = "✓"
else 
lock_text = "✘"    
end
...
if database:get(bot_id.."basel:Lock:edit"..msg.chat_id_) then    
lock_edit = "✓"
else 
lock_edit = "✘"    
end
...
if database:hget(bot_id.."basel:flooding:settings:"..msg.chat_id_, "flood") == "kick" then     
flood = "بالطرد"     
elseif database:hget(bot_id.."basel:flooding:settings:"..msg.chat_id_,"flood") == "keed" then     
flood = "بالتقييد"     
elseif database:hget(bot_id.."basel:flooding:settings:"..msg.chat_id_,"flood") == "mute" then     
flood = "بالكتم"           
elseif database:hget(bot_id.."basel:flooding:settings:"..msg.chat_id_,"flood") == "del" then     
flood = "بالمسح"           
else     
flood = "✘"     
end
...
if database:get(bot_id.."basel:Lock:Link"..msg.chat_id_) == "del" then
lock_links = "✓"
elseif database:get(bot_id.."basel:Lock:Link"..msg.chat_id_) == "ked" then
lock_links = "بالتقييد"    
elseif database:get(bot_id.."basel:Lock:Link"..msg.chat_id_) == "ktm" then
lock_links = "بالكتم"    
elseif database:get(bot_id.."basel:Lock:Link"..msg.chat_id_) == "kick" then
lock_links = "بالطرد"    
else
lock_links = "✘"    
end
if database:get(bot_id.."basel:Lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = "✓"
elseif database:get(bot_id.."basel:Lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = "بالتقييد"    
elseif database:get(bot_id.."basel:Lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = "بالكتم"   
elseif database:get(bot_id.."basel:Lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = "بالطرد"    
else
lock_cmds = "✘"    
end
if database:get(bot_id.."basel:Lock:User:Name"..msg.chat_id_) == "del" then
lock_user = "✓"
elseif database:get(bot_id.."basel:Lock:User:Name"..msg.chat_id_) == "ked" then
lock_user = "بالتقييد"    
elseif database:get(bot_id.."basel:Lock:User:Name"..msg.chat_id_) == "ktm" then
lock_user = "بالكتم"    
elseif database:get(bot_id.."basel:Lock:User:Name"..msg.chat_id_) == "kick" then
lock_user = "بالطرد"    
else
lock_user = "✘"    
end
if database:get(bot_id.."basel:Lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = "✓"
elseif database:get(bot_id.."basel:Lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = "بالتقييد"    
elseif database:get(bot_id.."basel:Lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = "بالكتم"    
elseif database:get(bot_id.."basel:Lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = "بالطرد"    
else
lock_hash = "✘"    
end
...
if database:get(bot_id.."basel:Lock:Bot:kick"..msg.chat_id_) == "del" then
lock_bots = "✓"
elseif database:get(bot_id.."basel:Lock:Bot:kick"..msg.chat_id_) == "ked" then
lock_bots = "بالتقييد"   
elseif database:get(bot_id.."basel:Lock:Bot:kick"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "✘"    
end
...
if database:get(bot_id.."basel:Lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = "✓"
elseif database:get(bot_id.."basel:Lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = "بالتقييد"    
elseif database:get(bot_id.."basel:Lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = "بالكتم"    
elseif database:get(bot_id.."basel:Lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = "بالطرد"    
else
lock_spam = "✘"    
end        
if not database:get(bot_id.."basel:Reply:Manager"..msg.chat_id_) then
rdmder = "✓"
else
rdmder = "✘"
end
if not database:get(bot_id.."basel:Reply:Sudo"..msg.chat_id_) then
rdsudo = "✓"
else
rdsudo = "✘"
end
if not database:get(bot_id.."basel:Lock:ID:Bot"..msg.chat_id_)  then
idgp = "✓"
else
idgp = "✘"
end
if not database:get(bot_id.."basel:Lock:ID:Bot:Photo"..msg.chat_id_) then
idph = "✓"
else
idph = "✘"
end
if not database:get(bot_id.."basel:Lock:kick"..msg.chat_id_)  then
setadd = "✓"
else
setadd = "✘"
end
if not database:get(bot_id.."basel:Lock:Add:Bot"..msg.chat_id_)  then
banm = "✓"
else
banm = "✘"
end
...
Num_Flood = database:hget(bot_id.."basel:flooding:settings:"..msg.chat_id_,"floodmax") or 0
local text = 
"*\n◈︙ اعدادات الكروب ."..
"\n- - - - -"..
...
database:setex(bot_id.."basel:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
local Text= [[
    ◈︙ ارسل النص الان .
    ◈︙ يمكنك اضافة ما يلي .
...
if Owner(msg) then
database:del(bot_id.."basel:Klesh:Id:Bot"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '◈︙ تم مصح كليشة الايدي .')
end
return false  
end 

if database:get(bot_id.."basel:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"◈︙ تم الغاء تعيين الايدي .") 
database:del(bot_id.."basel:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."basel:Set:Id:Gp"..msg.chat_id_..""..msg.sender_user_id_) 
database:set(bot_id.."basel:Klesh:Id:Bot"..msg.chat_id_,text:match("(.*)"))
send(msg.chat_id_, msg.id_,'◈︙ تم تعيين الايدي .')    
end

if text == 'ايدي' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'basel:Lock:ID:Bot'..msg.chat_id_) then
if not database:sismember(bot_id..'basel:Spam:Group'..msg.sender_user_id_,text) then
database:sadd(bot_id.."basel:Spam:Group"..msg.sender_user_id_,text) 
...
local NumMsg = database:get(bot_id..'basel:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."basel:Comd:New:rt:User:"..msg.chat_id_..Id) or Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'basel:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Num_Games = database:get(bot_id.."aaaZaa:Add:Num"..msg.chat_id_..msg.sender_user_id_) or 0
local Add_Mem = database:get(bot_id.."basel:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
...
local get_id = database:get(bot_id.."basel:Klesh:Id:Bot"..msg.chat_id_)
if not database:get(bot_id..'basel:Lock:ID:Bot:Photo'..msg.chat_id_) then
...
local Id = data.id_
local NumMsg = database:get(bot_id..'basel:messageUser'..msg.chat_id_..':'..data.id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."basel:Comd:New:rt:User:"..msg.chat_id_..Id) or Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'basel:message_edit'..msg.chat_id_..data.id_) or 0
local Num_Games = database:get(bot_id.."aaaZaa:Msg_User"..msg.chat_id_..":"..data.id_) or 0
local Add_Mem = database:get(bot_id.."basel:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
...
if text and text:match("^ايدي @(.*)$") and not database:get(bot_id..'basel:Lock:ID:Bot'..msg.chat_id_) then
...
if text == 'رسائلي' then
local nummsg = database:get(bot_id..'basel:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 1
local Text = '◈︙ عدد رسائلك : '..nummsg..' .'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح رسائلي' then
database:del(bot_id..'basel:messageUser'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '◈︙ تم مسح كل رسائلك .'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'سحكاتي' or text == 'تعديلاتي' then
local edit = database:get(bot_id..'basel:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Text = '◈︙ سحكاتك : '..edit..' .'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
database:del(bot_id..'basel:message_edit'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = '◈︙ تم مسح سحكاتك :'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'جهاتي' then
local addmem = database:get(bot_id.."basel:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
local Text = '◈︙ عدد جهاتك : '..addmem..' .'
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'مسح جهاتي' then
database:del(bot_id..'basel:Add:Memp'..msg.chat_id_..':'..msg.sender_user_id_)
...
database:incrby(bot_id.."basel:messageUser"..msg.chat_id_..":"..msg.sender_user_id_,NUMNKO)  
...
database:incrby(bot_id.."basel:messageUser"..msg.chat_id_..":"..iduserr,numadded)  
...
database:incrby(bot_id.."basel:messageUser"..msg.chat_id_..":"..result.sender_user_id_,Num)  
...
if text == "تنظيف المشتركين" and Devbasel(msg) then
local pv = database:smembers(bot_id..'basel:UsersBot')  
local sendok = 0
for i = 1, #pv do
...
database:srem(bot_id..'basel:UsersBot',pv[i])  
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
if text == "تنظيف الكروبات" and Devbasel(msg) then
local group = database:smembers(bot_id..'basel:Chek:Groups')  
local w = 0
local q = 0
for i = 1, #group do
...
database:srem(bot_id..'basel:Chek:Groups',group[i])  
w = w + 1
end
...
if text == ("تحديث السورس") and Devbasel(msg) then  
send(msg.chat_id_,msg.id_,'◈︙ تم تحديث السورس .')
os.execute('rm -rf basel.lua')
os.execute('rm -rf start.lua')
download_to_file('https://raw.githubusercontent.com/baselabaza/basel/master/basel.lua', 'basel.lua') 
download_to_file('https://raw.githubusercontent.com/baselabaza/basel/master/start.lua', 'start.lua') 
dofile('basel.lua')  
return false
end


if text == 'تفعيل البوت الخدمي' and Devbasel(msg) then  
database:del(bot_id..'basel:Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'◈︙ تم تفعيل البوت الخدمي .') 
end
if text == 'تعطيل البوت الخدمي' and Devbasel(msg) then  
database:set(bot_id..'basel:Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'◈︙ تم تعطيل البوت الخدمي .') 
end
if text and text:match("^تعيين عدد الاعضاء (%d+)$") and Devbasel(msg) then
local Num = text:match("تعيين عدد الاعضاء (%d+)$") 
database:set(bot_id..'basel:Num:Add:Bot',Num) 
send(msg.chat_id_, msg.id_,'◈︙ تم تعيين عدد الاعضاء : '..Num..' .')
end
if text =='الاحصائيات' and DevBot(msg) then
local Groups = database:scard(bot_id..'basel:Chek:Groups')  
local Users = database:scard(bot_id..'basel:UsersBot')  
send(msg.chat_id_, msg.id_,'◈︙ احصائيات بوتك .\n\n◈︙ عدد الكروبات : '..Groups..' .\n◈︙ عدد المشتركين : '..Users..' .')
end
if text == 'جلب نسخة احتياطية' and Devbasel(msg) then
local list = database:smembers(bot_id..'basel:Chek:Groups')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
NAME = 'basel Chat'
ASAS = database:smembers(bot_id.."basel:Basic:Constructor"..v)
MNSH = database:smembers(bot_id.."basel:Constructor"..v)
MDER = database:smembers(bot_id.."basel:Manager"..v)
MOD = database:smembers(bot_id.."basel:Mod:User"..v)
link = database:get(bot_id.."basel:Link_Group"..v) or ''
if k == 1 then
t = t..'"'..v..'":{"basel":"'..NAME..'",'
else
t = t..',"'..v..'":{"basel":"'..NAME..'",'
...
local Text_Dev = database:get(bot_id..'basel:Text_Dev')
if Text_Dev then 
...
if text == 'الملفات' and Devbasel(msg) then
t = '◈︙ الملفات .\n- - - - -\n'
i = 0
for v in io.popen('ls basel_Files'):lines() do
if v:match(".lua$") then
...
if Devbasel(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/baselabaza/basel/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n◈︙ اهلا بك في قائمة ملفات سورس باسل .\n◈︙ الملفات الموجودة .\n- - - - -\n\n"
local TextE = "\n- - - - -\n◈︙ علامة الصح تعني الملف مفعل .\n".."◈︙ علامة الخطأ تعني الملف تعطل .\n"
local NumFile = 0
for name,Info in pairs(res.plugins_) do
local Check_File_is_Found = io.open("basel_Files/"..name,"r")
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and Devbasel(msg) then
local name_t = {string.match(text, "^(تعطيل ملف) (.*)(.lua)$")}
local file = name_t[2]..'.lua'
local file_bot = io.open("basel_Files/"..file,"r")
if file_bot then
io.close(file_bot)
t = "◈︙ الملف : {"..file.."} .\n◈︙ تم تعطيله وحذفه ."
else
...
local json_file, res = https.request("https://raw.githubusercontent.com/baselabaza/basel/master/"..file)
if res == 200 then
os.execute("rm -fr basel_Files/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('nn1nnn.lua')  
else
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and Devbasel(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/baselabzaza/basel/master/"..file)
if res == 200 then
local chek = io.open("basel_Files/"..file,'w+')
...
if text == "مسح جميع الملفات" and Devbasel(msg) then
os.execute("rm -fr basel_Files/*")
send(msg.chat_id_,msg.id_,"◈︙ تم حذف جميع الملفات .")
return false
end
if text == 'نقل الاحصائيات' and Devbasel(msg) then
local Users = database:smembers('basel:'..bot_id.."userss")
local Groups = database:smembers('basel:'..bot_id..'groups') 
for i = 1, #Groups do
database:sadd(bot_id..'basel:Chek:Groups',Groups[i])  
local list1 = database:smembers('basel:'..bot_id..'creatorbasic:'..Groups[i])
for k,v in pairs(list1) do
database:sadd(bot_id.."basel:Basic:Constructor"..Groups[i], v)
end
local list2 = database:smembers('basel:'..bot_id..'creator:'..Groups[i])
for k,v in pairs(list2) do
database:sadd(bot_id.."basel:Constructor"..Groups[i], v)
end
local list3 = database:smembers('basel:'..bot_id..'owners:'..Groups[i])
for k,v in pairs(list3) do
database:sadd(bot_id.."basel:Manager"..Groups[i], v)
end
local list4 = database:smembers('basel:'..bot_id..'mods:'..Groups[i])
for k,v in pairs(list4) do
database:sadd(bot_id.."basel:Mod:User"..Groups[i], v)
end
database:set(bot_id.."basel:Lock:tagservrbot"..Groups[i],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'basel:'..lock..Groups[i],"del")    
end
end
for i = 1, #Users do
database:sadd(bot_id..'basel:UsersBot',Users[i])  
end
send(msg.chat_id_, msg.id_,'◈︙ تم نقل : '..#Groups..' كروب .\n◈︙ تم نقل : '..#Users..' مشترك .\n◈︙ من التحديث القديم الى التحديث الجديد .')
end
if text == 'حذف كليشة المطور' and Devbasel(msg) then
database:del(bot_id..'basel:Text_Dev')
send(msg.chat_id_, msg.id_,'◈︙ تم حذف كليشة المطور .')
end
if text == 'وضع كليشة المطور' and Devbasel(msg) then
database:set(bot_id..'basel:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,'◈︙ ارسل الكليشة الان .')
return false
end
if text and database:get(bot_id..'basel:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_) then
if text == 'الغاء' then 
database:del(bot_id..'basel:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'◈︙ تم الغاء حفظ كليشة المطور .')
return false
end
database:set(bot_id..'basel:Text_Dev',text)
database:del(bot_id..'basel:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'◈︙ تم حفظ كليشة المطور .')
return false
end
if text == 'رفع نسخة احتياطية' and Devbasel(msg) then   
...
if text == "تحديث" and Devbasel(msg) then
dofile("basel.lua")  
...
{
{text = '- Source basel .', url = "https://t.me/baselabaza"}
},
{
{text = '- basel .', url = "https://t.me/xb_0b"}
},
{
{text = '- MY BOT .', url = "https://t.me/abazaorgbot"}
},
}
...
{
{text = '- قفل الاستيكرات .', callback_data=msg.sender_user_id_.."/locksticar"},{text = '- فتح الاستيكرات .', callback_data=msg.sender_user_id_.."/unlocksticar"},
},
{
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'basel:Num:Add:Bot') or 0) and not Devbasel(msg) then
send(msg.chat_id_, msg.id_,'◈︙ لا يمكنك تفعيل البوت لان عدد الاهضاء اقل من : {'..(database:get(bot_id..'basel:Num:Add:Bot') or 0)..' .')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'basel:Chek:Groups',msg.chat_id_) then
...
if data.members_[i].status_.ID == "ChatMemberStatusCreator" then
owner_id = admins[i].user_id_
database:sadd(bot_id..'basel:Basic:Constructor23'..msg.chat_id_, owner_id)
end
end
end,nil)
database:sadd(bot_id..'basel:Chek:Groups',msg.chat_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if not database:sismember(bot_id..'basel:Chek:Groups',msg.chat_id_) then
...
database:set(bot_id.."basel:Private:Group:Link"..msg.chat_id_,LinkGp) 
...
if text == 'تفعيل' and not DevBot(msg) and not database:get(bot_id..'basel:Free:Add:Bots') then 
local res = https.request('https://brok-aapi.ml/API/Sub.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
send(msg.chat_id_,msg.id_,'◈︙ اشترك بقناة السورس وارجع دز الامر عمري .\n◈︙ قناة السورس : @BASELABAZA .')   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'basel:Num:Add:Bot') or 0) and not Devbasel(msg) then
send(msg.chat_id_, msg.id_,'◈︙ لا يمكنك تفعيل البوت لان عدد الاعضاء اقل من : {'..(database:get(bot_id..'basel:Num:Add:Bot') or 0)..' .')
return false
end
...
database:sadd(bot_id..'basel:Basic:Constructor'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
NameChat = NameChat:gsub('"',"") 
...
if not database:get(bot_id..'basel:Start:Time'..msg.sender_user_id_) then
...
database:setex(bot_id..'basel:Start:Time'..msg.sender_user_id_,60,true)
return false
end
if not Devbasel(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') then
...
sendText(Id_Sudo,'◈︙ تم ارسال الاستيكر الى : ['..string.sub(ta.first_name_,0, 40)..'](tg://user?id='..ta.id_..')',0,'md') 
return false
end;end;end,nil);end,nil);end,nil);end,nil);end
if Devbasel(msg) and msg.reply_to_message_id_ ~= 0  then    
...
{text = '- Source basel .', url = "https://t.me/baselabaza"}
    ...
    database:del(bot_id.."basel:Link_Group"..Chat_id) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:del(bot_id.."basel:Chek:Welcome"..Chat_id) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:set(bot_id.."basel:Reply:Sudo"..Chat_id,true)   
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:set(bot_id..'basel:Lock:ID:Bot'..Chat_id,true) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:set(bot_id..'basel:Lock:ID:Bot:Photo'..Chat_id,true) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:set(bot_id.."basel:Kick:Me"..Chat_id,true)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:set(bot_id.."basel:Reply:Manager"..Chat_id,true)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:set(bot_id.."basel:Link_Group"..Chat_id,true) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:set(bot_id.."basel:Chek:Welcome"..Chat_id,true) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:del(bot_id.."basel:Reply:Sudo"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:del(bot_id..'basel:Lock:ID:Bot'..Chat_id) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:del(bot_id..'basel:Lock:ID:Bot:Photo'..Chat_id) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:del(bot_id.."basel:Kick:Me"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:del(bot_id.."basel:Reply:Manager"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
...
{text = '- Source basel .', url = "https://t.me/baselabaza"}
    ...
    database:set(bot_id.."basel:Lock:AddMempar"..Chat_id,"kick")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    ...
    database:set(bot_id.."basel:Lock:text"..Chat_id,true) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."basel:Lock:Join"..Chat_id,"kick")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."basel:Lock:Bot:kick"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."basel:Lock:tagservr"..Chat_id,true)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."basel:Lock:edit"..Chat_id,true) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."basel:Lock:Link"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."basel:Lock:User:Name"..Chat_id,"del") 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."basel:Lock:hashtak"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."basel:Lock:Sticker"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."basel:Lock:Animation"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."basel:Lock:Video"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."basel:Lock:Photo"..Chat_id,"del")    
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."basel:Lock:Audio"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."basel:Lock:vico"..Chat_id,"del")    
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."basel:Lock:forward"..Chat_id,'del')  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."basel:Lock:Document"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."basel:Lock:Contact"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."basel:Lock:Spam"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:hset(bot_id.."basel:flooding:settings:"..Chat_id ,"flood","del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."basel:Lock:Inlen"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."basel:Lock:AddMempar"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."basel:Lock:text"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."basel:Lock:Join"..Chat_id) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."basel:Lock:Bot:kick"..Chat_id)   
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."basel:Lock:tagservr"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."basel:Lock:edit"..Chat_id) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."basel:Lock:Link"..Chat_id) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."basel:Lock:User:Name"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."basel:Lock:hashtak"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."basel:Lock:Sticker"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."basel:Lock:Animation"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."basel:Lock:Video"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."basel:Lock:Photo"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."basel:Lock:Audio"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."basel:Lock:vico"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."basel:Lock:forward"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."basel:Lock:Document"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."basel:Lock:Contact"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."basel:Lock:Spam"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:hdel(bot_id.."basel:flooding:settings:"..Chat_id ,"flood")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."basel:Lock:Inlen"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
...
{text = '- Source basel .', url = "https://t.me/baselabaza"}
    ...
    database:srem(bot_id..'basel:Chek:Groups','-100'..data.channel_.id_)  
    end
    end
    ...
    database:del(bot_id..'basel:nwe:mem:group'..msg.chat_id_) 
    send(msg.chat_id_, msg.id_,'\n- تم تعطيل التحقق' ) 
    end
    if text == 'تفعيل التحقق' and Addictive(msg) then  
    database:set(bot_id..'basel:nwe:mem:group'..msg.chat_id_,'true') 
    send(msg.chat_id_, msg.id_,'\n- تم تفعيل التحقق' ) 
    end 
    
    if msg.content_.ID == "MessageChatJoinByLink" and database:get(bot_id..'basel:nwe:mem:group'..msg.chat_id_) == 'true'then
    numphoto = {'3','8','9','6'}
...
if text and not database:sismember(bot_id..'basel:Spam:Group'..msg.sender_user_id_,text) then
database:del(bot_id..'basel:Spam:Group'..msg.sender_user_id_) 
end
------------------------------------------------------------------------
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
database:set(bot_id..'basel:User:Name'..msg.sender_user_id_,data.username_)
end;end,nil)   
------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
database:set(bot_id.."basel:Who:Added:Me"..msg.chat_id_..":"..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = database:get(bot_id.."basel:Lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
------------------------------------------------------------------------
if text and database:get(bot_id.."basel:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = database:get(bot_id.."basel:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
database:del(bot_id.."basel:Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
database:del(bot_id.."basel:Set:Cmd:Group:New"..msg.chat_id_)
database:srem(bot_id.."basel:List:Cmd:Group:New"..msg.chat_id_,text)
...
database:del(bot_id.."basel:Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
------------------------------------------------------------------------
if data.message_.content_.text_ then
local NewCmmd = database:get(bot_id.."basel:Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
local Name_Bot = (database:get(bot_id.."basel:Name:Bot") or "تشاكيx")
if not database:get(bot_id.."basel:Fun_Bots"..msg.chat_id_) then
...
------------------------------------------------------------------------
basel_Started_Bot(msg,data)
basel_Files(msg)
elseif (data.ID == "UpdateMessageEdited") then
local msg = data
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.message_id_)},function(extra, result, success)
database:incr(bot_id..'basel:message_edit'..result.chat_id_..result.sender_user_id_)
local Text = result.content_.text_
if database:get(bot_id.."basel:Lock:edit"..msg.chat_id_) and not Text and not BasicConstructor(result) then
...
if database:get(bot_id.."basel:Lock:Link"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(@)(.*)") then
if database:get(bot_id.."basel:Lock:User:Name"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(#)(.*)") then
if database:get(bot_id.."basel:Lock:hashtak"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
end 
...
------------------------------------------------------------------------
if text and text:match("/") then
if database:get(bot_id.."basel:Lock:Cmd"..msg.chat_id_) then
DeleteMessage(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
end 
...
------------------------------------------------------------------------
if text then
local basel_Msg = database:get(bot_id.."basel:Add:Filter:Rp2"..text..result.chat_id_)   
if basel_Msg then    
Reply_Status(result,result.sender_user_id_,"reply","📬┇"..basel_Msg)  
DeleteMessage(result.chat_id_, {[0] = data.message_id_})     
return false
end
end
...
local msg = data.message_
local text = msg.content_.text_
local Get_Msg_Pin = database:get(bot_id..'basel:Msg:Pin:Chat'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;database:del(bot_id..'basel:Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del(bot_id..'basel:Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
database:srem(bot_id..'basel:Chek:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
database:srem(bot_id..'basel:Chek:Groups',v)  
end
...
database:sadd(bot_id..'basel:Chek:Groups',v)  
end end,nil)
end;end;end
